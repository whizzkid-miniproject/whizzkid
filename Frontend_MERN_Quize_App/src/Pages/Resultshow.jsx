  ...
  return (
    <div className=" w-11/12 shadow-2xl ml-16  mt-24">
      ...
      <div className="flex -mt-24">
        ...
        <iframe src="https://giphy.com/embed/MB75OzWrpUMOWfBHg0" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/stickers/school-hard-concentrate-MB75OzWrpUMOWfBHg0">via GIPHY</a></p>
        </div>
        <div className="w-2/5  mt-24 p-8">
          ...
          <table>
            <tr>
              <td>Total Marks:</td>
              <td> {count}/{questionArr.length}</td>
            </tr>
          </table>
      ...
      <div className=" absolute  bg-blue-500 rounded-2xl right-24 top-28 border-2 mb-8 p-2 pl-4  pr-4 ">
        <Link to="/">
          <button className="text-xl font-bold ">Attempt More Quizes</button>
        </Link>
      </div>
    </div>
  );
