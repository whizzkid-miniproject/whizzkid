...
export const Navbarnew = () => {
  ...
  return (
    <div className="w- h-24 m-auto flex bg-slate-800 mb-8 ">
      <Link to="/" className="w-4/12 flex ">
        <img
          ...
          alt=""
        />
        <img src="./question1.gif" alt="" className="w-3/5 " />
      </Link>
        ...
        <div className="flex">
          <div className=" pt-2">
            {userName !== null || adminName !== null ? (
              <div className="flex ">
                <div
                  className="font-medium cursor-pointer text-xl text-white"
                ...
                <div
                  ...
                  className="ml-4 font-medium cursor-pointer text-xl text-white"
                >
                  LOGOUT
                </div>
              </div>
            ) : (
              <Link to="/register" className="font-medium mt-16 ml-24 text-slate-100 text-2xl">
                SIGN IN
              </Link>
            )}
          </div>
